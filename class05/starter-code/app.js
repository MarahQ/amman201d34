...
return[summArray,`${summ1},${summ2},${summ3} was passed in as an array of numbers, and ${summArray} is their sum.`]
}
...
function multiplyArray(multArr) { //eslint-disable-line
  let multi1 = multiply(testArray[0], testArray[1]);
  let multi2 = multiply(testArray[2],multi1[0]);
  return[multi2[0],`The numbers ${testArray} have a product of ${multi2[0]}.`]
}
